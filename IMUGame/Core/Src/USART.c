...
static char string[6];  //4 letters
if (freq < 0) {
	string[0] = '-';
	freq = -freq;
}
...
string[1] = (freq / 1000) + '0'; 			// Thousands
string[2] = (find_unit(freq / 100)) + '0'; // Hundreds
string[3] = (find_unit(freq / 10)) + '0';  // Tens
string[4] = (find_unit(freq)) + '0'; 	 	// Ones
string[5] = '\0'; // Null terminator
return string;
}
